      ...
      <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
          <div class="col-lg-10 align-self-end">
            ...
            >Your Favorite Source of Free Bootstrap Themes</h1>
        ...
        <div class="row no-gutters">
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/1.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/1.jpg"/>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/2.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/2.jpg"/>
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
                <div class="project-name">Project Name</div>
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/3.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/3.jpg"/>
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
                <div class="project-name">Project Name</div>
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/4.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/4.jpg"/>
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
                <div class="project-name">Project Name</div>
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/5.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/5.jpg"/>
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
                <div class="project-name">Project Name</div>
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="~/assets/img/portfolio/fullsize/6.jpg">
              <g-image class="img-fluid" src="~/assets/img/portfolio/thumbnails/6.jpg"/>
