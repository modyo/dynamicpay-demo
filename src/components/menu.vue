    ...
    <div class="top-header d-none d-sm-block">
      <div class="container d-flex">
        <div class="top-header--left">
          <a href class="top-header__link link-left active">
            <small>Personal</small>
          </a>
          <a href class="top-header__link link-left">
            <small>Golden</small>
          </a>
          <a href class="top-header__link link-left">
        ...
        <div class="top-header--right ml-auto">
          <a
            href="https://dynamicbank.modyo.cloud/retail/places"
            class="top-header__link link-right"
          >
            <small>
              <i class="icon-map-marker"></i> Locations
            </small>
          </a>
          <a href class="top-header__link link-right">
            <small>Customer Service</small>
          </a>
          <a href class="top-header__link link-right link-red">
    ...
    <header id="main-header">
      <div class="container d-flex">
        <g-link class="navbar-brand js-scroll-trigger" to="/">
          <img
            src="https://cloud.modyocdn.com/uploads/d401ed2b-bd7a-4c0a-9b32-e9f1e427bb74/original/dynamic_bank.png"
          >
        </g-link>
